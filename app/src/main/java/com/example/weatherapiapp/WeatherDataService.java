...
public class WeatherDataService {
    ...
    public void getCityForecastByID(String cityID, final ForecastByIDResponse forecastByIDResponse) {
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            @Override
            public void onErrorResponse(VolleyError error) {
                forecastByIDResponse.onError("smth wrong");
        ...
        //get each item in the array to assign to the weatherreport object
        MySingleton.getInstance(context).addToRequestQueue(request);
    ...
    public void getCityForecastByName(String name, final GetCityForecastByNameCallBack getCityForecastByNameCallBack) {
